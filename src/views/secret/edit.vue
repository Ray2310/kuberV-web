  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" label-width="150px">
      ...
      <el-form-item label="type" prop="type" label-width="150px">
        <el-select v-model="form.type" style="width: 35%">
          <el-option value="Opaque" label="Opaque"></el-option>
          <el-option value="kubernetes.io/dockerconfigjson" label="kubernetes.io/dockerconfigjson"></el-option>
        </el-select>
      </el-form-item>
  ...
  methods: {
    ...
    onSubmit(formName) {
      this.$refs[formName].validate((valid) => {
        ...
        this.$store.dispatch("secret/createSecret", this.form).then(res => {
